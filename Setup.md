...
2. Create the project env on **local disk**: `~/uv-envs/ds-cursor-demo`  
...
| Slow `uv sync` / packages on cloudfiles | Env should live under `~/uv-envs/…`, not inside the repo mount. Re-run bootstrap. |
